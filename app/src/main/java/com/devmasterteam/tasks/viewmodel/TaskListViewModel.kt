...
class TaskListViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _listOfTasks = MutableLiveData<List<TaskModel>>()
    val listOfTasks : LiveData<List<TaskModel>> = _listOfTasks
    ...
    fun status(id: Int, status: Boolean) {
